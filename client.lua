...
function onLoginStart()
    local data = exports['cr_json']:jsonGET("login/data.json", true, {["Username"] = base64Encode("Felhasználónév"), ["Password"] = base64Encode("Jelszó"), ["Clicked"] = false, ["haveRPTest"] = false, ["haveFirstTour"] = false, ["soundVolume"] = 1, ["canSeePassword"] = false}) or {["Username"] = base64Encode("Felhasználónév"), ["Password"] = base64Encode("Jelszó"), ["Clicked"] = false, ["haveRPTest"] = false, ["haveFirstTour"] = false, ["soundVolume"] = 1, ["canSeePassword"] = false}
